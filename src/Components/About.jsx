      ...
      <section className=" p-7 flex items-center justify-between flex-col md:flex-row">
        <div className="mt-4">
          <h4 className="text-black">
            Hello there , i am Manasseh a full-stack developer (Frontend Heavy){" "}
            <br /> at the moment i am on my way to complete my front-end course.{" "}
            <br /> I am majoring in Computer Science at Obafemi Awolowo
            University.
            <br /> I have been coding for over 2+ years now , still a lot to
            ...
            studying on mythologies <br /> . I have a keen eye for details and a
